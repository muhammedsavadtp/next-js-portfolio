export const cardContent = [
  // {
  //   title: "Netflix",
  //   description: "The world's most popular streaming Platform.",
  ...
  // {
  //   title: "olx",
  //   description: "The world's leading classifieds platform",
  //   url: "images/olx.png",
  ...
  {
    title: "shopping cart",
    description: "India's leading E-commerce marketplaces",
